...
Software code is considered open source if it meets OSI's [Open Source Definition](https://opensource.org/osd) - not just making source code available for others to look at, but licensing it in a way that allows others to redistribute, modify, verify, and in some cases even resell it.
