...
- **Security:** It's not open source, which would be ideal for inspecting whether our data (including personal notes!) are being sent anywhere. However, I feel at ease knowing that the company has proudly passed multiple [independent security audits](https://obsidian.md/security). Their business strategy isn't built around harvesting personal data like most other tech companies are, so I don't see this changing anytime soon.
